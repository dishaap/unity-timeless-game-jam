...
## 🏗️ RPG Builder Database Structure

### Item Creation Template:

```
RPG Builder > Items > Weapons > Whip

Item: "Serpent's Lash"
Base Stats:
  - Damage: 10 (Tier I), 12 (Tier II), 15 (Tier III), etc.
  - Attack Speed: 1.0

Affix Slots: 5 (max)
  - Slot 1: [Random Affix]
  - Slot 2: [Random Affix]
  - Slot 3: [Random Affix] (Tier III+)
  - Slot 4: [Random Affix] (Tier IV+)
  - Slot 5: [Random Affix] (Tier V only)

Loot Table: Weapon_Loot_Table
Drop Weight: Based on tier
```
...
**Weapon Affixes:** 20
**Artifact Affixes:** 15
**Stat Types in RPG Builder:** ~25
**Unique Visual Effects:** 10-15
