    ...
    public class Projectile : MonoBehaviour, ICanLaunch
    {
        ...
        public ProjectileData ProjectileData
        {
            get {
                ...
                // FEBRUARY 11, 2025: Added this to ensure the Inspector script properly uses the right value, not a clone!
        ...
        // September 30, 2025: Moved this from Start to Awake, and added null-coalescing assignment to avoid overwriting
        // any events that were set.
        protected virtual void Awake()
        {
            // Move this here (Awake is fine) or leave in Start, but do NOT overwrite if already set
        ...
        public void DoTriggerEnter(Collider other)
        {
            ...
            {
                Debug.Log($"Layer {other.gameObject.layer} not in mask {CollisionMask.value}");
                return;
            }
        ...
        {
            Debug.Log($"Setting projectile data to {newProjectileData.name}, from {(projectileData == null ? "Null" : projectileData.name)}");;
